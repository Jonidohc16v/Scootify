...
<section class="mb-6" style="width:55rem ; margin:5rem auto 5rem; padding: 2rem; box-shadow: 0 0 20px #34b38a">
    ...
    <div class="row">
        ...
        <!--Grid column-->
        <div class="col-md-9 mb-md-0 mb-5" style="margin-top:2rem">
            ...
            <div class="text-center text-md-left">
                <a class="btn btn-primary" style="background-color: #34b38a" onclick="document.getElementById('contact-form').submit();">Send</a>
            </div>
